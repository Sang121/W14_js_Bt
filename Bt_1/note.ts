...
console.log(`Title: ${ a.titles}\n Content: ${a.content}`); //Title: Các việc cần làm Content:  Code

console.log( `add note to list:`)

noteList1.addNotetoList(a)
console.log(`Name NoteList ${ noteList1.name}`); //Name NoteList TodoList
console.log( noteList1.Notes[0]); //Note { titles: 'Các việc cần làm ', content: ' Code' }
